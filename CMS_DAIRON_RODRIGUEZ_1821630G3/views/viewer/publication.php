...
<table class="table">
    ...
    <?php foreach(parent::all() as $publication):  ?>
        <tr>
            ...
            <a href="?controller=viewer&method=edit&id_publication=<?= $publication->id_publicacion?>">
                <button class="btn btn-outline-green">Editar</button>
            </a>
            <a href="?controller=viewer&method=delete&id_publication=<?= $publication->id_publicacion?>">
